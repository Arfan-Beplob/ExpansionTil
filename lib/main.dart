                            ...
                            Column(
                              children: [
                                InkWell(
                                    ...
                                    child: const Card(child: ListTile(title: Text('Lion',
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20
                                      ),
                                ...
                                InkWell(
                                    ...
                                    child: const Card(child: ListTile(title: Text('Tiger')))),
                                InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context)=>
                                    ...
                                    child: const Card(child: ListTile(title: Text('Goat')))),
                                InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context)=>
                                    ...
                                    child: const Card(child: ListTile(title: Text('Horse')))),
                                InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context)=>
                                    ...
                                    child: const Card(child: ListTile(title: Text('Donkey.')))),
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Card(
                                    color: Colors.yellow,
